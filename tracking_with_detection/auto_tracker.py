...
class AutoTracker:
    ...
    def run(self):
        ...
        while True:
            ...
            if not self._tracking_area is None:
    ...
    def _track_boxes(self, boxes):
        ...
        for box in boxes:
            ...
            self.add_with_update(tracker, self._current_frame, box)
    ...
    def add_with_update(self, tracker, frame, box):
        ...
        if is_intersecting_boxes(box, self._current_box):
