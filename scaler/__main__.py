...
if not (
    ...
    print("Нужно указать путь к исходным файлам. Параметр --video, --csv, --framescsv, --width, --height.")
else: 
    scaler = Scaler(args["video"], args["csv"], args["framescsv"], args["width"], args["height"])
    scaler.run()
